...
class TableElement(Element):
    ...
    Attributes:
        ...
        equations_inside (List['EquationElement']): The equations elements that are inside the table.
    """
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"TableElement(x_min={self.x_min}, y_min={self.y_min}, x_max={self.x_max}, y_max={self.y_max}, pipeline_step={self.pipeline_step}, table_data={self.table_data}, has_equation_inside={self.has_equation_inside}, equations_inside={self.equations_inside})"
